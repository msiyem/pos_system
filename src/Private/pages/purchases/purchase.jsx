...
export default function Purchase() {
  ...
  return (
    <div className=" bg-gray-50 w-full min-h-dvh px-[3%] overflow-auto">
      <div className="w-full px-3 text-gray-800 text-[18px] min-w-[820px]  bg-red-200/40   min-h-dvh rounded-xl flex flex-col border  border-gray-400 ">
        <div className="text-center text-[32px] font-serif font-semibold text-gray-700 my-10 mt-5">
          Purchase Product & Stock Update
        </div>
        <form className="w-full flex flex-col gap-5"
        onSubmit={handleSubmitPurchase}>
          <div className=" w-full flex gap-2 justify-between font-semibold text-[16px]">
            <div className="text-gray-800 text-[18px] mt-1 flex gap-2 ">
              Supplier <span className="text-red-500"> * </span>:{' '}
            </div>
            <div className="w-[70%] relative ">
              {/* supplier select  */}
              <div className="flex items-center gap-2 border-2 rounded-xl border-gray-400/70 hover:border-gray-400 text-gray-700  p-1.5 px-3">
                ...
                <input
                  ...
                  className=" w-full border-l border-gray-300 outline-0 pl-3"
                />
                {openSup ? (
                  <ChevronUp
            ...
            <button
              type='button'
              className="border w-[20%] flex items-center justify-center rounded-lg bg-red-600/85 hover:bg-red-600 text-white cursor-pointer"
          ...
          {supName ? (
            <div className="font-semibold flex justify-between text-blue-800">
              <div className="flex gap-2 items-center ">
                <span className="flex gap-2">
                  Selected Supplier Name <span className="text-red-500">*</span>
                  :
                </span>
                <span className="font-normal  border-gray-300 bg-white  border p-1.5 rounded-xl">
                  {supName}
                </span>
              </div>
              <div className="flex gap-2 items-center">
            ...
            <div className="font-semibold text-red-500/50 border rounded-xl px-5 text-center ">
          ...
          {items.length ? (
            <div className="font-semibold w-full ">
              <div className="text-[20px] text-blue-800 my-3 text-center">
              ...
              {items.map((item, index) => (
                ...
                >
                  ...
                  <span className="w-[22%] flex justify-around items-center">
                    ...
                    />
                    <X className='text-red-600 h-7 w-7 cursor-pointer ring rounded-full bg-white'
          ...
          <div className="w-full flex justify-between px-2 ">
            ...
            <button
              type="submit"
              className="bg-blue-600/80 text-white px-4 py-2 rounded-xl hover:bg-blue-600 cursor-pointer hover:scale-105"
            >
              Confirm Purchase
            </button>
          </div>
