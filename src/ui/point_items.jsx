...
export default function PointItems({ id, name, price, count, onUpdate, onDelete }) {
  return (
    <div className="relative w-full ring-gray-300 ring-1 rounded-lg flex justify-between items-center m-0 p-0">
      ...
      <div className="mb-3 mx-3 flex space-x-1 sm:space-x-2 items-center justify-center sm:mx-4 ">
        ...
        <span className="sm:px-2 ring-0  flex justify-center items-center text-sm sm:text-balance font-mono rounded-lg ">
          {count}
        </span>
        <button
