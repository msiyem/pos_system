export default function InputText({title,type,formData,handleChange,placeholder,name,required}) {
  return (
    <div className="flex items-center gap-2">
      <span className="font-semibold mb-1 text-nowrap w-[15ch]">{title} </span>
      ...
      <input
        ...
        className="border  p-2 py-1 w-full rounded-xl outline-0 hover:shadow hover:scale-101 hover:bg-blue-50"
        required={required}
      />
    </div>
  );
