...
import { supplierSchema } from '../../../forms/supplier.schema';
...
export default function AddSupplier() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex justify-center text-[#030006]">
      <div className="m-5 p-4 w-full max-w-[1000px] rounded-xl bg-gradient-to-r from-sky-100 to-cyan-100">
        ...
        >
          ...
          <div className="flex justify-between pt-4">
            ...
            <button
              ...
              className="flex gap-2 items-center bg-blue-500 text-white px-6 py-2 rounded-xl
