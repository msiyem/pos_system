        ...
        <div className="w-full flex flex-col gap-2 ml-5">
          ...
          <div className="text-gray-600 flex gap-6 text-[12px] sm:text-sm">
            <div className="flex items-center gap-2">
              ...
              <span>Joined: 19 Sep 2025</span>
            </div>
            <div className="flex items-center gap-2">
              <History className="h-4 w-4" />
              <span>Last Purchase: 20 Sep 2025</span>
            </div>
          </div>
      ...
      <div className="w-full border border-gray-300 rounded-lg p-2 py-5 bg-white">
        ...
        {/* dropdown info  */}
        {
          ...
          <div className="w-full">
            <p className='text-[18px] my-2 font-medium'>Contact Information :</p>
          ...
          <div className="w-full">
            <p className='text-[18px] mt-8 my-2 font-medium'>Address Information :</p>
            <table className="w-full text-gray-700 text-[16px]">
              <tbody>
            ...
            <div className='w-full my-10'>
              <table className='w-full text-center border border-gray-300 '>
                <tbody className=''>
                  ...
                  <tr className='border-b border-gray-300  '>
                    <th className='p-2 text-left'>Stainless Steel Water Bottle</th>
                    <td>10 May 2023</td>
                    <td>$1,500</td>
                    <td>1</td>
                    <td>$1,500</td>
          ...
          activeTab==='transition' &&(
            <div className='w-full  my-10 flex flex-col gap-10'>
              ...
              <div className='flex gap-4'>
                ...
                <div className='cursor-pointer py-0.5 flex items-center gap-2 border border-gray-300 w-fit px-3 rounded-lg shadow bg-blue-500/85 hover:bg-blue-500 text-white'>
                  <Calendar className='h-4 w-4 '/> <span>End Data</span>
                </div>
                <div className='cursor-pointer py-0.5 flex items-center gap-2 border border-gray-300 w-fit px-3 rounded-lg shadow hover:bg-gray-50'>All Types</div>
              </div>
              ...
              <table className='w-full text-center  '>
                <tbody className='ring-1 rounded-lg ring-gray-300'>
                  ...
                  <tr className='border-b border-gray-300  '>
                    <th className='p-2 text-left font-medium '>Premium Leather Wallet</th>
                  ...
                  <tr className='border-b border-gray-300 font-medium '>
                    <th className='p-2 text-left font-medium'>Wireless Earbuds</th>
                  ...
                  <tr className='border-b border-gray-300  '>
                    <th className='p-2 text-left font-medium'>Stainless Steel Water Bottle</th>
